  ...
  <div class="row">
		...
		<div class="col s12 m6 l4 xl3">
			<div class="card z-depth-3">
				...
				<div class="card-action center-align">
					<a class="waves-effect waves-light btn button-color-grupo activator"><i class="material-icons right">add</i>Veja Mais</a>
				</div>
			</div>
		</div>	
		<!-- cardEnd -->
		...
		<div class="col s12 m6 l4 xl3">
			<div class="card z-depth-3">
				<div class="card-image">
					<img src="http://localhost/wordpress/wp-content/uploads/2018/03/pexels-photo-533189.jpeg">
					<span class="card-title">Física</span>
				</div>
				<div class="card-content">
					<p>I am a very simple card. I am good at containing small bits of information.
					I am convenient because I require little markup to use effectively.</p>
		...
		<div class="col s12 m6 l4 xl3">
			<div class="card z-depth-3">
				<div class="card-image">
					<img src="http://localhost/wordpress/wp-content/uploads/2018/03/pexels-photo-533189.jpeg">
					<span class="card-title">Direito Humanos</span>
				</div>
				<div class="card-content">
					<p>I am a very simple card. I am good at containing small bits of information.
					I am convenient because I require little markup to use effectively.</p>
